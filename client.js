...
console.log(`Power: 2 ^ 3 = ${powerResult[0].result}`);
// Test temperature 
const f = await client.CelsiusToFahrenheitAsync({ a: 25 });
console.log("25°C -> F =", f[0].result);

const c = await client.FahrenheitToCelsiusAsync({ a: 77 });
console.log("77°F -> C =", c[0].result);

const k = await client.CelsiusToKelvinAsync({ a: 0 });
console.log("0°C -> K =", k[0].result);
